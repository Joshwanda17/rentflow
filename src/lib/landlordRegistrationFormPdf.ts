...
export async function generateLandlordRegistrationFormPdf(
  ...
  pdf.setFontSize(7.5);
  pdf.text('welile.tech', pw - margin, 12, { align: 'right' });
  ...
  pdf.text('Powered by Welile  •  welile.tech', margin, ph - 7);
...
export async function shareLandlordRegistrationFormPdf(
  ...
  caption = 'Welile Landlord Registration Form — please print, fill in, and return to register the landlord. welile.tech',
  phone?: string,
) {
