/**
 * Full list of sovereign countries of the world, each tagged with its
 * continent so we can auto-derive the continent from a country pick.
 * Used by the profile-completion country selector.
 */
...
export const WORLD_COUNTRIES_UGANDA_FIRST: WorldCountry[] = [
  WORLD_COUNTRIES.find((c) => c.name === "Uganda")!,
  ...WORLD_COUNTRIES.filter((c) => c.name !== "Uganda").sort((a, b) =>
