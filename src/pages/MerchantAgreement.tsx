...
} from '@/components/merchant/agreement/MerchantAgreementContent';
...
export default function MerchantAgreementPage() {
  ...
  const getFormattedAgreement = () => {
    let text = MERCHANT_AGREEMENT_TEXT;
    const namePhone = profile?.full_name || profile?.phone || 'Merchant Agent';
    text = text.replace('[Merchant Name / Phone]', namePhone);
  ...
  const handleDownload = () => {
    ...
    a.href = url;
    a.download = `Welile_Merchant_Agent_Agreement_${MERCHANT_AGREEMENT_VERSION}.txt`;
  ...
  const handlePrint = () => {
    ...
    printWindow.document.write(`
      <html>
        <head>
          <title>Welile Merchant Agent Agreement</title>
