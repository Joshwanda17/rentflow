  ...
  return (
    <div className="min-h-screen bg-background pb-20 md:pb-0">
      <Helmet>
        ...
        />
        <link rel="canonical" href="https://welile.tech/marketplace" />
        ...
        />
        <meta property="og:url" content="https://welile.tech/marketplace" />
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            url: 'https://welile.tech/marketplace',
            isPartOf: {
              '@type': 'WebSite',
              name: 'Welile.com',
              url: 'https://welile.tech/',
            },
          })}
        </script>
      </Helmet>
