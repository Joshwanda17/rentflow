  ...
  return (
    <>
      ...
      <Sheet open={settingsOpen} onOpenChange={setSettingsOpen}>
        <SheetTrigger asChild>
          <button
            className="md:hidden fixed bottom-24 right-4 z-[60] h-10 w-10 rounded-full bg-primary shadow-lg flex items-center justify-center active:scale-95 transition-transform touch-manipulation"
            aria-label="Language & Currency"
          >
            <div className="flex flex-col items-center">
