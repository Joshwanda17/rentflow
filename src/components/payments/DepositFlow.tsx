...
import { Loader2, CheckCircle2, Phone, Calendar, Clock, Hash, AlertCircle, History, Building2, Banknote, Upload, Receipt, Copy, Truck, User, Handshake, Home, FileText } from 'lucide-react';
