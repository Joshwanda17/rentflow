...
const liquidbuttonVariants = cva(
  "inline-flex items-center transition-colors justify-center cursor-pointer gap-2 whitespace-nowrap rounded-md text-sm font-medium disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default:
      ...
      >
        <div
          className="absolute top-0 left-0 z-0 h-full w-full rounded-full
            shadow-[0_0_6px_hsl(var(--foreground)/0.04),0_2px_6px_hsl(var(--foreground)/0.08)]
            transition-all"
        />
        ...
        <div className="pointer-events-none absolute top-0 left-0 -z-10 h-full w-full overflow-hidden rounded-md bg-foreground/5" />
    ...
    >
      <div
        ...
        style={{
          ...
          transform: isPressed ? "translateX(60%)" : "translateX(-60%)",
