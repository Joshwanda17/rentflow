  ...
  if (variant === 'icon') {
    return (
      <Button
        ...
        className="h-16 w-16 shrink-0 rounded-full border-2 bg-background hover:bg-muted/50 shadow-sm touch-manipulation active:scale-[0.95] transition-all [&_svg]:!size-7"
        onClick={onClick}
        disabled={disabled}
