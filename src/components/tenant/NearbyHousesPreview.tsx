    ...
    >
      ...
      <div className="relative w-full h-28 bg-muted">
        ...
        <div className="absolute bottom-1 left-1">
          <ShareHouseButton listingId={listing.id} title={listing.title} region={listing.region} dailyRate={listing.daily_rate} shortCode={listing.short_code} mode="whatsapp" />
        </div>
