...
- `coo-wallet-to-portfolio` and `manager-portfolio-topup` still hard-override to the proxy agent wallet (unchanged). If operator-selection-wins is desired there too, apply the same pattern.
