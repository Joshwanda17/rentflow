...
BEGIN
  ...
  -- Authorization: privileged platform roles OR any staff explicitly granted
  -- the 'landlord-ops' dashboard. Mirrors the dashboard's own access gate so
  -- anyone who can SEE the Reject button can actually USE it.
  IF NOT (
