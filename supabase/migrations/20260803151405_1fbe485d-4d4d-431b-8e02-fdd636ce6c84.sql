...
BEGIN
  ...
  -- Manual per-user override (compliance/CFO) replaces the new-account cap.
  -- 0 or negative means "no new-account restriction".
  SELECT daily_withdrawal_cap_ugx INTO v_override
...
INSERT INTO public.kyc_profiles (user_id, daily_withdrawal_cap_ugx, level_source, last_reviewed_at)
VALUES ('fe1e9f51-a2c3-49fc-bd40-b2c143afe628', 0, 'manual', now())
ON CONFLICT (user_id) DO UPDATE
  SET daily_withdrawal_cap_ugx = 0,
      level_source = 'manual',
