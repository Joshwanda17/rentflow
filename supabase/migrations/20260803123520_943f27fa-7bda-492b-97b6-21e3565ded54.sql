...
BEGIN
  ...
  LOOP
    ...
    -- Lines earn while they are live. 'active' is the status stamped by
    -- trg_psm_activate_line when the plan money is disbursed as landlord float;
    -- 'completed' lines still earn for the days they were live in this cycle.
    -- Tenant payment behaviour deliberately does NOT gate this: the company
    -- absorbs tenant default, never the partner.
