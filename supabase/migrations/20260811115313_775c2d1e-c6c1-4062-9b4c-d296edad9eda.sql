...
BEGIN
  ...
  -- Portfolios self-created by a funder land directly on 'pending_ops_approval'
  -- but still have no partner agreement details. A fresh completion invite for
  -- such a portfolio must be accepted, otherwise the partner's submission is
  -- rejected and the agreement preview stays blank forever.
