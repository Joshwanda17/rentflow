ALTER FUNCTION public.agent_allocate_tenant_payment(uuid, uuid, uuid, numeric, text)
  RENAME TO agent_allocate_tenant_payment_internal;

REVOKE ALL ON FUNCTION public.agent_allocate_tenant_payment_internal(uuid, uuid, uuid, numeric, text)
...
REVOKE ALL ON FUNCTION public.agent_allocate_tenant_payment(uuid, uuid, uuid, numeric, text)
  FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.agent_allocate_tenant_payment(uuid, uuid, uuid, numeric, text)
  TO authenticated;
