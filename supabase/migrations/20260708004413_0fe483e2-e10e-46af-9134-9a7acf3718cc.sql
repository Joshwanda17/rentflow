...
GRANT EXECUTE ON FUNCTION public.get_agent_ops_agent_stats(integer) TO authenticated;
GRANT EXECUTE ON FUNCTION public.get_agent_ops_agent_stats(integer) TO service_role;
