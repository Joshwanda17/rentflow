CREATE TABLE IF NOT EXISTS public._sc_smoke_results(step text, result text, at timestamptz default now());
GRANT ALL ON public._sc_smoke_results TO service_role;
...
BEGIN
  BEGIN
    ...
    VALUES (parent,'p@sc.local','00000000-0000-0000-0000-000000000000','authenticated','authenticated'),
           (a,'a@sc.local','00000000-0000-0000-0000-000000000000','authenticated','authenticated'),
           (b,'b@sc.local','00000000-0000-0000-0000-000000000000','authenticated','authenticated'),
           (ten,'t@sc.local','00000000-0000-0000-0000-000000000000','authenticated','authenticated'),
           (ops,'o@sc.local','00000000-0000-0000-0000-000000000000','authenticated','authenticated');
    INSERT INTO profiles(id,full_name) VALUES (parent,'Parent'),(a,'Sub A'),(b,'Sub B'),(ten,'Tenant X'),(ops,'Ops')
