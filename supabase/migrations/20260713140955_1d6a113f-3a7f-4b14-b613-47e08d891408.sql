...
AS $$
  -- Landlords are stored in public.landlords (house_listings.landlord_id -> landlords.id)
  ...
  UNION ALL
  -- Tenants are real users stored in public.profiles (house_listings.tenant_id -> profiles.id)
