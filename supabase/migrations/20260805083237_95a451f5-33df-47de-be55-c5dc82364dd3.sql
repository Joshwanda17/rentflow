ALTER TABLE public.referrals ALTER COLUMN bonus_amount SET DEFAULT 100;
ALTER TABLE public.referrals ALTER COLUMN restricted_amount SET DEFAULT 100;

UPDATE public.referrals
   SET bonus_amount = 100,
       restricted_amount = 100
 WHERE COALESCE(unlocked, false) = false
