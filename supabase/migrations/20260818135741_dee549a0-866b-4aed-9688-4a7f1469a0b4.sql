...
begin
  ...
  perform public.refresh_wallet_projection_for(p_agent_user_id);
...
GRANT EXECUTE ON FUNCTION public.record_merchant_float_delivery(text, uuid, numeric, text, uuid, timestamptz) TO authenticated;
GRANT EXECUTE ON FUNCTION public.record_merchant_float_delivery(text, uuid, numeric, text, uuid, timestamptz) TO service_role;