...
BEGIN
  BEGIN
    ...
    INSERT INTO rent_requests(tenant_id,landlord_id,agent_id,assigned_agent_id,rent_amount,status,
                              tenant_photo_url,national_id_number,tenant_name,tenant_phone)
      VALUES (ten,ll,parent,a,200000,'funded','https://example.com/p.jpg','SCSMOKE0001','SC Tenant','0700000222')
