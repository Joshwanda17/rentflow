...
BEGIN
  ...
  -- Strict ledger net: production + admin_correction, wallet scope
  ...
  -- Unspent post-Apr-1 credits guard (excludes synthetic / float / advance / writedown categories)
  ...
  -- Post balanced platform-only loss legs (admin_correction). Both legs use ledger_scope='platform'.
