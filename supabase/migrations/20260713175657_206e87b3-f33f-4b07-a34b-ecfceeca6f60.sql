...
BEGIN
  ...
  -- FIX: create_ledger_transaction takes (entries jsonb, idempotency_key text).
  -- Previously called as ('agent_tenant_float_allocation', v_legs) which resolved
  -- to the uuid-first overload and raised
