...
BEGIN
  ...
  SELECT
    ...
    p.phone,
    v.amount,
    -- Reveal the code for both active and expired deposits so verifiers can
    -- still read it back after expiry. Only hide it once the deposit has been
    -- verified (the code has already been consumed).
    CASE
