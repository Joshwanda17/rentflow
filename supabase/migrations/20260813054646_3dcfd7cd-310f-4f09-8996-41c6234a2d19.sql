CREATE OR REPLACE FUNCTION public.merchant_set_payout_numbers(p_float_phone text, p_personal_phone text)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
...
BEGIN
  ...
  VALUES (
    ...
    jsonb_build_object(
      'float_phone', v_float,
      'personal_phone', v_personal,
      'reason', 'Merchant saved float and personal payout numbers'
    )
  );
...
GRANT EXECUTE ON FUNCTION public.merchant_set_payout_numbers(text, text) TO service_role;