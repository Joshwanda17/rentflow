ALTER TABLE public.investor_portfolios
  ...
  ADD COLUMN IF NOT EXISTS locked_from_portfolio_id uuid;
...
BEGIN
  ...
  INSERT INTO public.investor_portfolios (
    investor_id, invite_id, agent_id, portfolio_code, investment_amount, duration_months,
    ...
    v_p.investor_id, v_p.invite_id, v_p.agent_id, v_code, v_locked, v_p.duration_months,
