-- Canonical landlord phone matcher.
-- Uses the EXACT same digit-normalization logic as search_landlords_fuzzy so
-- duplicate checks and the existing-landlord search always agree, regardless of
-- whether a stored phone is 0xxxxxxxxx, 256xxxxxxxxx or +256xxxxxxxxx.
