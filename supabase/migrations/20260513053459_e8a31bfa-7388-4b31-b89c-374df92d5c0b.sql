...
BEGIN
  ...
  LOOP
    ...
    -- Only the WALLET-SIDE leg of a repayment must be routed to a user
    -- (withdrawable). The platform-side leg legitimately credits the
    -- operational wallet — we do not interfere with it.
