...
Deno.serve(async (req) => {
  ...
  const description = rent
    ? `Support this tenant for ${ugx(rent)} by paying their landlord on the platform and earn ${ugx(monthly)} per month for the next 12 months Start here today welileapp.com.`
